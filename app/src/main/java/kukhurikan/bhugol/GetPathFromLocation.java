...
public class GetPathFromLocation extends AsyncTask<String, Void, PolylineOptions> {
    ...
    private String API_KEY = "AIzaSyAhCzt3ERl7JSKgljkivOoULfLwDC1Ae_c";
    private LatLng source, destination;
    private DirectionPointListener resultCallback;
    private Integer colors;

    public GetPathFromLocation(Integer colors, LatLng source, LatLng destination, DirectionPointListener resultCallback) {
        this.source = source;
    ...
    protected PolylineOptions doInBackground(String... url) {
        ...
        try {
            ...
            try {
                ...
                Log.d("URLLL",data); /// getting string
